...
describe('DownloadProgress', () => {
  ...
  it('shows which file of the bundle is downloading', () => {
    render(
      <DownloadProgress progress={{ file: 'laya.onnx.data', index: 2, total: 5, loaded: 0, size: 1685258240 }} />,
    );
  ...
  it('shows bytes received against the file size, with a percent', () => {
    render(
      <DownloadProgress
        progress={{ file: 'laya.onnx.data', index: 2, total: 5, loaded: 842629120, size: 1685258240 }}
      />,
    );
  ...
  it('shows only bytes received when the file size is unknown', () => {
    render(<DownloadProgress progress={{ file: 'laya.onnx', index: 1, total: 5, loaded: 1500000, size: null }} />);
